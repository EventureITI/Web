...
import { AddOutline, ArrowBackOutline, ArrowForwardOutline, SearchOutline } from 'react-ionicons'
    ...
    return (
        <div className='bg-gray-900'>
            ...
            <div className="self-stretch justify-between items-center gap-4 flex p-10 overflow-x-auto whitespace-nowrap">
                <div className="grow shrink basis-0 text-white text-[32px] font-semibold ">Event List</div>
                <div className="relative w-[346px]">
                    <input
                        type="search"
                        className="w-full h-[43px] px-6 py-3 text-white bg-[#c9c9c9]/20 rounded-lg"
                        placeholder="Search"
                    />
                ...
                <button className="h-10 px-8 py-2 bg-[#4fdfd1] rounded-lg justify-center items-center gap-2 inline-flex">
                    <AddOutline
                        color={'#ffffff'}
                        height="24px"
                        width="24px"
                    />
                    <div className="text-center text-white text-base font-normal">Add Event</div>
                </button>
            </div>
                ...
                <div className="justify-center items-end gap-8 flex mb-10">
                    <div className="px-3 py-2 opacity-50 rounded-lg justify-center items-center gap-2 flex cursor-pointer">
                        <ArrowBackOutline
                            ...
                            width="16px"
                        />
                        <div className="text-white text-base font-normal font-body">Previous</div>
                    </div>
                    <div className="justify-start items-center gap-4 flex">
                        <div className="px-3.5 py-2 bg-[#4fdfd1] rounded-lg flex-col justify-center items-center inline-flex">
                            <div className="text-white text-base font-normal font-body cursor-pointer">1</div>
                        </div>
                        <div className="px-3.5 py-2 rounded-lg flex-col justify-center items-center inline-flex cursor-pointer">
                            <div className="text-white text-base font-normal font-body">2</div>
                        </div>
                        <div className="px-3.5 py-2 rounded-lg flex-col justify-center items-center inline-flex cursor-pointer">
                            <div className="text-white text-base font-normal font-body">3</div>
                        </div>
                        <div className="px-4 py-2 rounded-lg flex-col justify-center items-center inline-flex cursor-pointer">
                            <div className="text-white text-base font-bold font-body leading-snug">...</div>
                        </div>
                        <div className="px-3.5 py-2 rounded-lg flex-col justify-center items-center inline-flex">
                            <div>
                                <div className="text-white text-base font-normal font-body cursor-pointer">10</div>
                            </div>
                        </div>
                        <div className="px-3.5 py-2 rounded-lg flex-col justify-center items-center inline-flex">
                            <div className="text-white text-base font-normal font-body cursor-pointer">11</div>
                        </div>
                        <div className="px-3.5 py-2 rounded-lg flex-col justify-center items-center inline-flex">
                            <div className="text-white text-base font-normal font-body cursor-pointer">12</div>
                        </div>
                    </div>
                    <div className="px-3 py-2 rounded-lg justify-center items-center gap-2 flex cursor-pointer">
                        <div className="text-white text-base font-normal font-body leading-none">Next</div>
                        <ArrowForwardOutline
                            color={'#ffffff'}
                            height="16px"
                            width="16px"
