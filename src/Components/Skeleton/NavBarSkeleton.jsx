    ...
    >
      <div className="max-w-screen-xl flex flex-nowrap items-center justify-between mx-auto p-4">
        ...
        <div className="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          <div>
            {/* SearchBar */}
            <div className="hidden form-control md:flex md:mr-16 lg:mr-28 xl:mr-44 relative lg:w-72 ">
              <div className="input text-white text-sm pb-1 animate-pulse h-8 rounded-lg lg:w-72 md:w-48  bg-[rgba(201,201,201,0.2)]" />
            </div>
          </div>
          <div>
            {auther?<div>
              <div className="btn btn-ghost cursor-default btn-circle avatar">
                <div className="w-10 rounded-full bg-[#d2d5db] opacity-40 animate-pulse"></div>
              </div>
            </div>:
            <div>
              <div className="btn btn-ghost cursor-default btn-circle avatar">
                <div className="w-28 rounded-lg h-10 pr-24 mr-10 bg-[rgba(201,201,201,0.2)] animate-pulse"></div>
              </div>
            </div>}
